    ...
    <div class="mx-auto max-w-7xl px-0">
      <div class="container justify-center items-center">
        <div class="content">
          ...
          <form method="POST" @submit="preventDefault(); checkOpenAICredit();" class="flex items-center mb-10">
            <label for="api_key" class="w-28 mr-4">API密钥:</label>
            <input type="text" placeholder="请输入您的API密钥：sk-" name="api_key" id="api_key"
              class="border border-gray-400 rounded px-2 py-1 w-full max-w-md focus:outline-none focus:border-blue-500"
              required>
...
export default {
  ...
  methods:{
    checkOpenAICredit() {
      console.log(document.getElementById("api_key"),'11')
